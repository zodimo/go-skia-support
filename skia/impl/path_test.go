...
// NOTE: Currently skipped due to implementation bug in AddRect with conic weights
// TODO: Fix AddRect implementation bug (index out of range in addRaw when ConicWeights is empty)
func TestPath_BoundsWithRects(t *testing.T) {
	t.Skip("Skipping due to AddRect implementation bug - see path.go:965")
